...
const colorVariants = {
  ...
  primary: {
    solid: 'bg-institutional-blue text-white',
    flat: 'bg-institutional-blue/10 text-institutional-blue',
    bordered: 'bg-transparent text-institutional-blue border-institutional-blue',
    dot: 'bg-institutional-blue',
  },
  secondary: {
    solid: 'bg-institutional-silver text-white',
    flat: 'bg-institutional-silver/10 text-institutional-silver',
    bordered: 'bg-transparent text-institutional-silver border-institutional-silver',
    dot: 'bg-institutional-silver',
  },
  success: {
