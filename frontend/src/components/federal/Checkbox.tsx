...
const colorClasses = {
  ...
  primary: 'border-federal-gold/30 checked:bg-federal-gold checked:border-federal-gold',
  secondary: 'border-federal-navy/30 checked:bg-federal-navy checked:border-federal-navy',
      ...
      <div className={`relative ${classNames.wrapper || ''}`}>
        ...
        <div
          className={`
            ...
            ${color === 'primary' ? 'peer-focus:ring-federal-gold' : ''}
            ${color === 'secondary' ? 'peer-focus:ring-federal-navy' : ''}
            ${classNames.icon || ''}
          `}
        >
          {/* Checkmark icon */}
