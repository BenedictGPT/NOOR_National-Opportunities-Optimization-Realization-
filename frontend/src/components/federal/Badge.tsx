...
const colorVariants = {
  ...
  primary: {
    solid: 'bg-federal-gold text-white',
    flat: 'bg-federal-gold/10 text-federal-gold',
    bordered: 'bg-transparent text-federal-gold border-federal-gold',
    dot: 'bg-federal-gold',
  },
  secondary: {
    solid: 'bg-federal-navy text-white',
    flat: 'bg-federal-navy/10 text-federal-navy',
    bordered: 'bg-transparent text-federal-navy border-federal-navy',
    dot: 'bg-federal-navy',
  },
  success: {
