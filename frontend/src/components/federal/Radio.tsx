...
const colorClasses = {
  ...
  primary: 'border-federal-gold/30 checked:border-federal-gold',
  secondary: 'border-federal-navy/30 checked:border-federal-navy',
...
const dotColorClasses = {
  default: 'bg-gray-600',
  primary: 'bg-federal-gold',
  secondary: 'bg-federal-navy',
